...
- State: `zenbedded/test/state` (`zenbedded_state_t`: `motor_arm_position`,
  `pendulum_axis_position`, both `float`, packed little-endian)
- Command: `zenbedded/test/cmd` (`zenbedded_command_t`: `motor_arm_position`,
  `float`)

...
// Struct to map standard ROS 2 types to their RIHS hashes
typedef struct
{
...
// The static ledger (Will be auto-generated by a script in the future)
...
// Helper function to look up a hash by type name
